...
export const metadata: Metadata = {
  title: {
    default: 'Lumière — Artisan Candles',
    template: '%s | Lumière',
  },
  description: 'Hand-poured, small-batch candles crafted to transform your space. Discover signature scents made with natural soy wax and premium fragrance oils.',
}
